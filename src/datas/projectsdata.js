export default {
    ...
    "naivetespartagees":{
        ...
        description: "Et quoniam inedia gravi adflictabantur, locum petivere Paleas nomine, vergentem in mare, valido muro firmatum, ubi conduntur nunc usque commeatus distribui militibus omne latus Isauriae defendentibus adsueti",
        skills: "planning · organisation · communication · visual identity · graphism · photoshop · exposing photographies",
        extraContent: [],
        extraBool: 0
    },
    "lafermedubuisson":{
    ...
    "pulpfestival":{
        ...
        skills: "programming · react native js · graphism · design of the application · communication",
        extraContent: [],
        extraBool: 0
    }
};